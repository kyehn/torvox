...
dependencies {
  ...
  // Shizuku privileged execution (DESIGN Shizuku switch): API + provider.
...
dependencies {
  pitestClasspath("org.pitest:pitest:1.30.0")
  pitestClasspath("org.pitest:pitest-command-line:1.30.0")
}
