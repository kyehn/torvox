...
/**
 * Round-234 table-driven tests for [shouldResetScrollOnInput] — the pure input-driven scroll-reset
 * decision (spec terminal-scrolling "五维归零判定": user input containing CR/LF snaps the viewport to the
 * live screen without waiting for PTY output).
 *
