package terminal.emulator.ocr

import androidx.compose.ui.test.hasTestTag
import androidx.compose.ui.test.junit4.v2.createAndroidComposeRule
import androidx.test.platform.app.InstrumentationRegistry
import terminal.emulator.MainActivity
import terminal.emulator.PixelFrame
import terminal.emulator.buildTemplate
import terminal.emulator.cellBottom
import terminal.emulator.cellRight
import terminal.emulator.cellX
import terminal.emulator.cellY
import terminal.emulator.decodeRgbaToPixels
import terminal.emulator.extractCell
import terminal.emulator.getBridge
import terminal.emulator.lastGridRowsDensity
import terminal.emulator.matchConfidence
import terminal.emulator.rowProfile
import terminal.emulator.saveAsPng
...
class PixelMatchingTest {
    ...
    // ── helpers removed — using shared terminal.emulator.* utils ──────
